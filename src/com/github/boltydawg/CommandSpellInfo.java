...
public class CommandSpellInfo implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(Main.scoreboard.getObjective("class").getScore(p.getName()).getScore()!=2) {p.sendMessage("only mages can use this command"); return true;}
		ArrayList<String> spells = Main.mages.getOrDefault(p.getUniqueId(), new ArrayList<String>());
